...
**APIs.json:** [https://raw.githubusercontent.com/api-evangelist/pg-and-e/refs/heads/main/apis.yml](https://raw.githubusercontent.com/api-evangelist/pg-and-e/refs/heads/main/apis.yml)
...
- **Human URL:** [https://www.pge.com/en/save-energy-and-money/energy-usage-and-tips/understand-my-usage/share-my-data.html](https://www.pge.com/en/save-energy-and-money/energy-usage-and-tips/understand-my-usage/share-my-data.html)
- **Base URL:** `https://api.pge.com`
...
- [OpenAPI](openapi/pg-and-e-share-my-data-api-openapi.yml) — [OpenAPI Specification](https://spec.openapis.org/oas/latest.html)
- [Postman Collection](collections/pg-and-e-share-my-data-api.postman_collection.json) — [Postman Collection 2.1](https://schema.getpostman.com/json/collection/v2.1.0/collection.json)
- [Open Collection](collections/pg-and-e-share-my-data-api.opencollection.json) — [Open Collection 1.0](https://schema.opencollection.com/opencollection/v1.0.0.json)

## Common Properties

- [GitHub Organization](https://github.com/pgetech)
- [LinkedIn](https://www.linkedin.com/company/pacificgasandelectric)
- [Share  My  Data](https://www.pge.com/en/save-energy-and-money/energy-usage-and-tips/understand-my-usage/share-my-data.html)
